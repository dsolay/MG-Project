		...
		<div class="container col-12 col-md-9 offset-md-1 pt-4">
			<form method="POST" action="${registerUrl}">
				<c:forEach items="${datos}" var="usuario">
					...
					<h5 class="text-center">¿Esta seguro/a de eliminar este registro?</h5>

				</c:forEach>

				<section>
					<label class="required full-width pt-3"><strong id="warningDeleteProject" class="full-width text-center" style="display: block">
						* Advertencia: Esta acción eliminarán todas los proyectos asociados a dicho usuario y las actividades asociadas a dicho proyecto.
					</strong></label>
				</section>

				<div class="row pt-3">
					<a href="Usuario?action=index" class="col-12 col-md-3 offset-md-3 mr-3 btn btn-secondary" role="button" aria-pressed="true">Cancelar</a>
